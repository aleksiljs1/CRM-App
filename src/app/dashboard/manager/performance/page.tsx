...
export default function PerformancePage() {
  ...
  if (viewingHistoryReport) {
    ...
    return (
      <div className="space-y-6 pb-10">
        {/* Back bar */}
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 px-5 py-3">
          <div className="flex items-center gap-3 min-w-0">
            <History className="h-5 w-5 text-amber-600 dark:text-amber-400 shrink-0" />
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="rounded-xl border border-brand-500/20 bg-gradient-to-br from-[#00968a]/5 to-[#00968a]/10 dark:from-[#00968a]/10 dark:to-[#00968a]/5 p-3 md:p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between md:flex-wrap">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap w-full md:w-auto">
            {/* Period Selector Pills */}
            <div className="inline-flex flex-wrap sm:flex rounded-lg border border-border bg-muted/50 p-0.5">
              {(["day", "week", "month"] as Period[]).map((p) => (
                <button
                  key={p}
                  onClick={() => setReportPeriod(p)}
                  className={`sm:flex-none rounded-md px-3 py-1.5 text-sm font-medium transition-all ${
                    reportPeriod === p
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-[#00968a] px-4 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-[#007d73] disabled:opacity-60 w-full sm:w-auto"
            >
              {reportLoading ? (
                <>
        ...
        {historyLoading ? (
          ...
          <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm -mx-3 sm:mx-0">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[360px] md:min-w-[640px] text-left text-sm">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="hidden md:table-cell px-4 py-3 font-medium text-muted-foreground">Department</th>
                    <th className="hidden md:table-cell px-4 py-3 font-medium text-muted-foreground">Generated By</th>
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm -mx-3 sm:mx-0">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[480px] md:min-w-[960px] text-left text-sm">
              <thead>
                <tr className="border-b bg-muted/50">
                  ...
                  <th className="hidden md:table-cell px-4 py-3 font-medium text-muted-foreground">Role</th>
                  <th className="hidden md:table-cell px-4 py-3 font-medium text-muted-foreground">Dept</th>
                  ...
                  <th className="hidden md:table-cell px-4 py-3 text-center font-medium text-muted-foreground">High Pri</th>
                  <th className="hidden md:table-cell px-4 py-3 text-center font-medium text-muted-foreground">Avg/Mo</th>
                  <th className="hidden md:table-cell px-4 py-3 text-center font-medium text-muted-foreground">Emails</th>
                  <th className="hidden md:table-cell px-4 py-3 text-center font-medium text-muted-foreground">Clients</th>
                </tr>
              </thead>
              <tbody>
                {performanceData.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="hidden md:table-cell px-4 py-3 text-muted-foreground">{item.user.role}</td>
